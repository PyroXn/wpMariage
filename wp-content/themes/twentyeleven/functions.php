...
function twentyeleven_setup() {
	...
	$custom_header_support = array(
		...
		'width' => apply_filters( 'twentyeleven_header_image_width', 960 ),
		'height' => apply_filters( 'twentyeleven_header_image_height', 248 ),
...
function my_login_head() {
	...
	body.login #login h1 a {
		background: url('".get_bloginfo('template_url')."/images/SetP.png') no-repeat scroll center top transparent;
		height: 141px;
		width: 313px;
                margin-left: 12px;
	}
